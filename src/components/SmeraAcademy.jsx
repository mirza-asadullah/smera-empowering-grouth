      ...
      <div className="container academy-inner">
        <div className="academy-content">
          ...
          <h2 className="academy-title">
            ...
            <span className="accent-text">SMERA Academy</span>
          </h2>

          <p className="academy-desc">
            Unlock your potential with our comprehensive e-learning platform
            designed specifically for SME owners and professionals. Access
            world-class resources, expert-led courses, and a community of
            innovators.
          </p>
